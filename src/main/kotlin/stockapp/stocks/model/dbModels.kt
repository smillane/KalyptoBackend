...
data class ReturnStockData(val quote: JsonNode, val stats: JsonNode, val previousDividends: List<JsonNode>,
                           val nextDividend: JsonNode, val largestTrades: JsonNode, val insiderTrading: List<JsonNode>)